...
class FaqController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('technician.faq.index', compact('faqs', 'categories', 'search', 'categoryId'));
    }
    ...
    public function show($id)
    {
        ...
        return view('technician.faq.show', compact('faq', 'relatedFaqs'));
    }
    ...
    public function category($slug)
    {
        ...
        return view('technician.faq.category', compact('category', 'faqs'));
    }
}
