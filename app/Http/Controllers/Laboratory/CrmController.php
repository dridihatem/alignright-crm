...
class CrmController extends Controller
{
    ...
    {
        return view('laboratory.crm.index');
    }
                ...
                ->addColumn('action', function ($row) {
                    $btn = '<div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="' . route('laboratory.crm.contacts.show', $row->id) . '">
                                <i class="ti ti-eye me-1"></i> View
                            </a>
                            <a class="dropdown-item" href="' . route('laboratory.crm.contacts.edit', $row->id) . '">
                                <i class="ti ti-pencil me-1"></i> Edit
                            </a>
                            <a class="dropdown-item" href="' . route('laboratory.crm.contacts.interactions', $row->id) . '">
    ...
    public function create()
    {
        ...
        return view('laboratory.crm.contacts.create', compact('users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('laboratory.crm.index')->with('success', 'Contact created successfully.');
    }
    ...
    public function show($id)
    {
        ...
        return view('laboratory.crm.contacts.show', compact('contact', 'users'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('laboratory.crm.contacts.edit', compact('contact', 'users'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('laboratory.crm.contacts.show', $id)->with('success', 'Contact updated successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('laboratory.crm.index')->with('success', 'Contact deleted successfully.');
    }
    ...
    public function interactions($id)
    {
        ...
        return view('laboratory.crm.contacts.interactions', compact('contact', 'interactions'));
    }
