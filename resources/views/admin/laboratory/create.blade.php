<x-app-layout>
    <x-slot name="title">{{ __('master.create_laboratory') }} - {{ __('master.admin') }}</x-slot>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{ __('master.create_laboratory') }}</li>
            </ol>
        </nav>
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="d-flex gap-2">
                                ...
                                <a href="{{ route('admin.laboratories.list') }}" class="btn btn-secondary">
