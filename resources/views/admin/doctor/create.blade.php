<x-app-layout>
    <x-slot name="title">{{ __('master.add_doctor') }}</x-slot>
            ...
            <div class="col-12">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{ __('master.add_doctor') }}</li>
                    </ol>
                </nav>
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div>
                            <h5 class="mb-0">
                                ...
                                {{ __('master.add_doctor') }}
                            </h5>
                            <small class="text-muted">{{ __('master.create_new_doctor_account') }}</small>
                        </div>
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="send_credentials">
                                                {{ __('master.send_credentials_email') }}
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('role_id') is-invalid @enderror" id="role_id" name="role_id" required>
                                            ...
                                            <option value="2" {{ old('role_id') == 2 ? 'selected' : 'selected' }}>{{ __('master.doctor') }}</option>
                                        </select>
                                        @error('role_id')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="card-body">
                                    <div class="d-grid gap-2">
                                        <button type="submit" class="btn btn-primary">
                                            <i class="fas fa-save me-1"></i> {{ __('master.create_doctor') }}
                                        </button>
                                        <a href="{{ route('admin.doctors.list') }}" class="btn btn-outline-secondary">
