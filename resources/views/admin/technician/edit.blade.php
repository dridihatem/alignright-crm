<x-app-layout>
    <x-slot name="title">{{ __('master.edit_technician') }} - {{ __('master.admin') }}</x-slot>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('admin.technicians.show', $technician->id) }}">{{ __('master.technician_details') }}</a>
                </li>
                <li class="breadcrumb-item active">{{ __('master.edit_technician') }}</li>
            </ol>
        </nav>
        ...
        <div class="card mb-4">
            <div class="card-header">
                <h5 class="mb-0">
                    ...
                    {{ __('master.edit_technician') }}
                </h5>
                <small class="text-muted">{{ __('master.update_technician_information') }}</small>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.technicians.update', $technician->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('address') is-invalid @enderror" 
                                          id="address" name="address" rows="3">{{ old('address', $technician->address) }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror" 
                                    ...
                                    <option value="active" {{ old('status', $technician->status) == 'active' ? 'selected' : '' }}>{{ __('master.active') }}</option>
                                    <option value="inactive" {{ old('status', $technician->status) == 'inactive' ? 'selected' : '' }}>{{ __('master.inactive') }}</option>
                                </select>
                                @error('status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('specialization') is-invalid @enderror" 
                                       id="specialization" name="specialization" value="{{ old('specialization', $technician->specialization) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('license_number') is-invalid @enderror" 
                                       id="license_number" name="license_number" value="{{ old('license_number', $technician->license_number) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('bio') is-invalid @enderror" 
                                          id="bio" name="bio" rows="3">{{ old('bio', $technician->bio) }}</textarea>
                                @error('bio')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save me-1"></i> {{ __('master.update_technician') }}
                                </button>
                                <a href="{{ route('admin.technicians.show', $technician->id) }}" class="btn btn-secondary">
