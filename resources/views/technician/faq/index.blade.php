<x-app-layout>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-8">
                                <form method="GET" action="{{ route('technician.faq.index') }}">
                                    ...
                                    <div class="row">
                                        @foreach($categories as $category)
                                            <div class="col-md-3 mb-3">
                                                <a href="{{ route('technician.faq.category', $category->slug) }}" 
    ...
    <script>
        function markHelpful(faqId) {
            fetch(`{{ url('technician/faq') }}/${faqId}/helpful`, {
                method: 'POST',
                headers: {
        ...
        function markNotHelpful(faqId) {
            fetch(`{{ url('technician/faq') }}/${faqId}/not-helpful`, {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                    'Content-Type': 'application/json',
