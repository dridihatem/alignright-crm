...
$('#export-pdf').click(function() {
   ...
   let url = "/technician/cases/exportcasesPdf?" +
       "case_id=" + encodeURIComponent(case_id) +
       "&treatment_type=" + encodeURIComponent(treatment_type) +
       "&technician_id=" + encodeURIComponent(technician_id) +
...
window.open(url, '_blank');
 ...
 var tickets_list_table = $('#tickets_list_table').DataTable({
    processing: true,
     serverSide: true,
     orderable: false, 
     ajax: "/technician/tickets/get_tickets",
     columns: [
 ...
 var treatment_types_table = $('#treatment_types_table').DataTable({
    processing: true,
     serverSide: true,
     orderable: false, 
     ajax: "/technician/treatment_types_list/" + $('#case_id').val(),
     columns: [
         {data: 'name', name: 'name',orderable: false},
         {data: 'status', name: 'status',orderable: false},
